...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { episodio: @translation.episodio, stagione: @translation.stagione, tipo: @translation.tipo, titolo: @translation.titolo, user_id: @translation.user_id } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { episodio: @translation.episodio, stagione: @translation.stagione, tipo: @translation.tipo, titolo: @translation.titolo, user_id: @translation.user_id } }
